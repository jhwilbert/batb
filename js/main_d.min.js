...
function checkPlay(){DEBUG&&console.log("checkPlay() :: CurrentTime:",player.getCurrentTime(),"Totaltime",player.getDuration());0<player.getCurrentTime()&&player.getCurrentTime()<player.getDuration()-0.5&&hideNoise();0!=player.getCurrentTime()&&player.getCurrentTime()>player.getDuration()-0.5&&showNoise()}function showNoise(){noiseon||(DEBUG&&console.log("hidenoise() :: Noise fadein..."),$("#video-container").fadeIn(),noiseon=!0)}
