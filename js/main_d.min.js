...
a.data,"Unstarted -------------------------------"),console.log("onytplayerStateChange(): Availible:",player.getAvailableQualityLevels(),"Decided:",player.getPlaybackQuality()));player.setPlaybackQuality("medium");showNoise();window.focus();keysEnabled=!1;break;case 2:DEBUG&&console.log("------------------------------- onytplayerStateChange() :: State",a.data,"Paused ----------------------------------");window.focus();break;case 3:DEBUG&&console.log("------------------------------- onytplayerStateChange() :: State",
