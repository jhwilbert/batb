...
function onPlayerReady(){DEBUG&&console.log("onPlayerReady(e) :: Calling noise and cueing playlist...",videosDesktop);$("#player").css("opacity","1");player.cuePlaylist(videosDesktop,0,0,defaultQuality);(-1<navigator.userAgent.toLowerCase().indexOf("chrome")||!0==$.browser.msie)&&player.playVideoAt(0);startCheck()}function onPlayerError(a){DEBUG&&console.log("onPlayerError() :: Error",a)}
